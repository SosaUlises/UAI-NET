...
namespace SosaUlisesParcial
{
    public partial class Form1 : Form
    {
        ...
        {
            FormAddActFisica formAct = new FormAddActFisica();
            formAct.ShowDialog();
        }

        private void caloriasConsumidasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (Clase.ListaAlimento.Count == 0)
            {
                MessageBox.Show("Primero debes agregar un alimento!",
                    "Error",MessageBoxButtons.OK,MessageBoxIcon.Warning);
            }
            else
            {
                FormCaloriasConsumidas formCal = new FormCaloriasConsumidas();
                formCal.ShowDialog();
            }
        ...
        private void resumenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debes realizar los calculos antes de ver su RESUMEN!!",
